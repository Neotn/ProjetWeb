...
if(isset($_POST['supprimer']))
{
	...
	if(isset($_POST['firstName']) and isset($_POST['lastName']) and isset($_POST['password']) and isset($_POST['userMail']) and isset($_POST['adress']) and isset($_POST['gender']))
	{
	 ...
	 $clientF->supprimerClient($_POST['pid']);
...
if(isset($_GET['idc'])) 	
{
 $resultat=$clientF->rechercherClient($_GET['idc']);
}
...
<head>
	  ...
	  var setLink = function (){
		 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/supprimerAdmin.php?idc="+id);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/backend/views/supprimerAdmin.php"){
			 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/supprimerAdmin.php?idc="+id);
		  }
	  };
            ...
            <nav id="sidebar">
               ...
               <div class="menu-section">
                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        <a href="index-2.html">
                      <!-- Change me-->  <i class="fas fa-tachometer-alt"></i>
                        Dashboard
                        </a>
                     </li>
                     <li>
                     ...
                     <li>
                        ...
                        <!-- Change me--> <i class="far fa-file"></i>
                        pages
                        </a>
               ...
               <div class="menu-section">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <!-- Change me--> <i class="fas fa-chart-pie"></i>
                        Charts
                        </a>
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Remove Admin</h3>
                                    <form name="f" method="POST" action="supprimerAdmin.php">
									<div class="row">
                                          <div class="col-md-12">
                                             <p>
												...
												<?php  $clients=$clientF->afficherClients();
													foreach($clients as $client)
													{
												?>
												<option id="<?php echo $client['id']?>" style=""><?php echo $client['id']?></option>
													<?php }?>
												</select>
                                             </p>
                                          </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text"  readonly name="firstName" id="firstName" value="<?php foreach($resultat as $row){echo  $row['first_name'];}  ?>">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" readonly value="<?php echo  $row['last_name'];?>" name="lastName" id="lastName">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="password" readonly value="<?php echo  $row['password'];?>"  name="password" id="password">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Email</label>
                                                <input type="text" readonly value="<?php echo  $row['email'];?>"  name="userMail" id="userMail">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Adress</label>
                                                <input type="text" readonly value="<?php echo  $row['adress'];?>" name="adress" id="adress">
                                             </p>
                                          </div>
                                       </div>
									    <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Status</label>
                                                <input type="text" readonly value="<?php echo  $row['status'];?>"  name="status" id="status">
                                             </p>
                                          </div>
                                       </div>
									    ...
									    <div class="row">
                                          <div class="col-md-12">
                                             <p>
												...
												<input type="text" readonly value="<?php echo  $row['gender'];?>"  name="gender" id="gender">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
