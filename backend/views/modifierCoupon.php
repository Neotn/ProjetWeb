...
if(isset($_GET['idc']))
{
	...
	if(isset($_POST['code']) and isset($_POST['reduction']) and isset($_POST['dateDebut']) and isset($_POST['dateFin']) and isset($_POST['pid']))
		 {
			 $code=$_POST['code'];
			 $reduction=$_POST['reduction'];
			 $dateDebut=$_POST['dateDebut'];
			 $dateFin=$_POST['dateFin'];
			 $Coupon= new Coupon($code,$reduction,$dateDebut,$dateFin);

	 $CouponC->modifierCoupon($Coupon,$_POST['pid']);
...
<head>
	  ...
	  var setLink = function (){
		 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/modifierCoupon.php?idc="+id);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/backend/views/modifierCoupon.php"){
			 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/modifierCoupon.php?idc="+id);
		  }
	  };
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Coupon Info</h3>
                                    <form name="f" method="POST" action="modifierCoupon.php">
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
									   ...
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" required placeholder="Enter Coupon Code" name="code" value="<?php foreach($resultat as $row){echo  $row['code'];}  ?>">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="number" min=0 max=100 required placeholder="Enter Reduction" value="<?php echo  $row['reduction']; ?>" name="reduction">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="date" required placeholder="Enter Start Date" name="dateDebut" value="<?php echo  $row['date_Debut']; ?>">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="date" required placeholder="Enter End Date" name="dateFin" value="<?php echo  $row['date_Fin']; ?>">
                                             </p>
                                          </div>
                                       </div>                                      
                                       <div class="row">
