...
$CouponC=new CouponC();
	 ...
	 {
		 if(isset($_POST['code']) and isset($_POST['reduction']) and isset($_POST['dateDebut']) and isset($_POST['dateFin']))
		 {
			 $code=$_POST['code'];
			 ...
			 //header('Location: AfficherCoupons.php');
		 }else{
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" required placeholder="Enter Coupon Code" name="code">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="number" min=0 max=100 required placeholder="Enter Reduction" name="reduction">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="date" required placeholder="Enter Start Date" name="dateDebut">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="date" required placeholder="Enter End Date" name="dateFin">
                                             </p>
                                          </div>
                                       </div>                                      
                                       <div class="row">
