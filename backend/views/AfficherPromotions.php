...
include "../entites/promotion.php";
	...
	$promotionF = new promotionF();
								...
								$promotionF =new promotionF();
								$listePromos=$promotionF ->afficherPromotions();
                     ...
                     <div class="col-md-12">
                        <div class="page-box">
						   ...
						   <div class="table-responsive">
								...
								<tr>
								<td><center>Promotion ID</center></td>
								<td><center>Product ID</center></td>
								<td><center>Category ID</center></td>
								<td><center>Promotion</center></td>
								</tr>

								<?PHP
								foreach($listePromos as $promotion ){
									?>
									<tr>
									<td><?PHP echo "<center>".$promotion ['id']."</center>"; ?></td>
									<td><?PHP if(!$promotion['idProduit']){ echo "<center>-</center>";}else{echo "<center>".$promotion['idProduit']."</center>";}   ?></td>
									<td><?PHP if(!$promotion['idCategorie']){ echo "<center>-</center>";}else{echo "<center>".$promotion['idCategorie']."</center>";}  ?></td>
									<td><?PHP echo "<center>".$promotion ['tauxPromo']."%</center>";  ?></td>
