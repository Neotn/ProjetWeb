...
if(isset($_POST['modifier']))
{
	...
	if(isset($_POST['firstName']) and isset($_POST['lastName']) and isset($_POST['password']) and isset($_POST['userMail']) and isset($_POST['adress']) and isset($_POST['gender']) and isset($_POST['status']))
	{
	 ...
	 $gender=$_POST['gender'];
	 $status=$_POST['status'];
	 $client = new admin($first_name,$last_name,$password,$mail,$adress,$gender,$status);
...
<head>
	  ...
	  var setLink = function (){
		 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/modifierAdmin.php?idc="+id);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/backend/views/modifierAdmin.php"){
			 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/modifierAdmin.php?idc="+id);
		  }
	  };
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Modify Admin</h3>
                                    <form name="f" method="POST" action="modifierAdmin.php">
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text"  name="firstName" id="firstName" value="<?php foreach($resultat as $row){echo  $row['first_name'];}  ?>">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" value="<?php echo  $row['last_name'];?>" name="lastName" id="lastName">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="password" value="<?php echo  $row['password'];?>"  name="password" id="password">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Email</label>
                                                <input type="text" value="<?php echo  $row['email'];?>"  name="userMail" id="userMail">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Adress</label>
                                                <input type="text" value="<?php echo  $row['adress'];?>" name="adress" id="adress">
                                             </p>
                                          </div>
                                       </div>
									    <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Status</label>
                                                <input type="text" value="<?php echo  $row['status'];?>"  name="status" id="status">
                                             </p>
                                          </div>
                                       </div>
									    ...
									    <div class="row">
                                          <div class="col-md-12">
                                             <p>
												...
												<input type="text" value="<?php echo  $row['gender'];?>"  name="gender" id="gender">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <button type="submit" class="btn btn-success" value="modifier" name="modifier">
                                                <i class="fa fa-check"></i>
                                                Save
                                                </button>
