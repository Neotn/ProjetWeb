...
{
	if(isset($_POST['Select2']) and isset($_POST['taux']))
	{
		$promotionProduit = new Promotion($_POST['Select2'],null,$_POST['taux']);
		
		
		$promotionF->ajouterPromotionProduit($promotionProduit);
...
{
	if(isset($_POST['Select3']) and isset($_POST['taux']))
	{
		$promotionProduit = new Promotion(null,$_POST['Select3'],$_POST['taux']);
		
		$promotionF->ajouterPromotionCategorie($promotionProduit);
				header('Location: AfficherPromotions.php');
...
<!-- Mirrored from themescare.com/demos/seipkon-admin-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Feb 2019 17:02:44 GMT -->
<head>
	  ...
	  function change()
{
	...
	var tp = document.getElementById("idP");
	var tc = document.getElementById("idC");

	var bp = document.getElementById("Bprod");
	var bc = document.getElementById("Bcat");
	
	if(f.Select1.value==="Product")
	{
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Add Promotion</h3>
                                    <form name="f" method="POST" action="ajoutPromotion.php">
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label id="idP">Product ID :</label>
                                                <select id="Select2" name="Select2" >										
												<?php  $promotions=$promotionF->afficherIDP();
													foreach($promotions as $promotion)
													{
												?>
												<option id="" style=""><?php echo $promotion['idProduit']?></option>
													<?php }?>
												</select>
                                             </p>
                                          </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label id="idC" style="visibility:hidden;">Category ID :</label>
                                                <select style="visibility:hidden;" id="Select3" name="Select3" >										
												<?php  $promotions=$promotionF->afficherIDC();
													foreach($promotions as $promotion)
													{
												?>
												<option id="" style=""><?php echo $promotion['idCategorie']?></option>
													<?php }?>
												</select>
                                             </p>
                                          </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input id="taux" name="taux" type="number" min=0 max=100 required />
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <button id="Bprod" type="submit" class="btn btn-success" value="Produit" name="Produit">
                                                <i class="fa fa-check"></i>
                                                ADD Product Promotion
                                                </button>
												<button id="Bcat" type="submit" class="btn btn-success" value="Categorie" name="Categorie" style="visibility:hidden;">
                                                <i class="fa fa-check"></i>
