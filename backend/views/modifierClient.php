...
<head>
	  ...
	  var setLink = function (){
		 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/modifierClient.php?idc="+id);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/backend/views/modifierClient.php"){
			 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/modifierClient.php?idc="+id);
		  }
	  };
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Modify Client</h3>
                                    <form name="f" method="POST" action="modifierClient.php">
