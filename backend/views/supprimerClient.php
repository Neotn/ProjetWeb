...
<head>
	  ...
	  var reset = function()
	  {
		localStorage.setItem('opt',undefined);  
	  };
	  
	  var setLink = function (){
		 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/supprimerClient.php?idc="+id);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/backend/views/supprimerClient.php"){
			 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/supprimerClient.php?idc="+id);
		  }
	  };
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Remove Client</h3>
                                    <form name="f" method="POST" action="supprimerClient.php">
									<div class="row">
                                          <div class="col-md-12">
                                             <p>
