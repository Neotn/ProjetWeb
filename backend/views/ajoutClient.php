                                    ...
                                    <form method="POST" action="ajoutClient.php">
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Enter Client First Name :" name="firstName" id="firstName" required>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Client Last Name :" name="lastName" id="lastName" required>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Email</label>
                                                <input type="email" placeholder="Enter Email :" name="userMail" id="userMail" required>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
